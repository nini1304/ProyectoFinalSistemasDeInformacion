...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../cssregistrarc/registrarcc.css"/>
  ...
  <div class="row">
    ...
    <div class="col-sm" id="parteformulario">
        <form method="POST" action="vistaregistrarc.php" id="formulario">
  <div class="mb-3">
      <label for="u" class="form-label" id="cititulo">CI Paciente</label>
    ...
    <div id="emailHelp" class="form-text">Ingrese el CI del paciente para registrar su cita</div>
            ...
            <button type="submit" class="btn btn-primary" id="boton">Aceptar</button>
</form>
    </div>
